...
var IS_NODE = __w_pdfjs_require__(58);
    ...
    return {
      getPattern: function RadialAxial_getPattern(ctx, owner, shadingFill) {
        ...
        if (type === "axial") {
          ...
          grad = tmpCtx.createRadialGradient(p0[0], p0[1], r0, p1[0], p1[1], r1);
        }
...
var createMeshCanvas = function createMeshCanvasClosure() {
  ...
  function createMeshCanvas(bounds, combinesScale, coords, colors, figures, backgroundColor, cachedCanvases) {
    ...
    for (var _i = 0, _ii = figures.length; _i < _ii; _i++) {
      drawFigure(data, figures[_i], context);
    }
...
var _scripting_utils = __w_pdfjs_require__(138);
    ...
    value: function render() {
      ...
      if (this.renderInteractiveForms) {
        ...
        element.addEventListener("input", function (event) {
          ...
          _this5.setPropertyOnSiblings(element, "value", event.target.value, "value");
        });
...
var PolylineAnnotationElement = /*#__PURE__*/function (_AnnotationElement9) {
  ...
  function PolylineAnnotationElement(parameters) {
    ...
    var isRenderable = !!(parameters.data.hasPopup || parameters.data.title || parameters.data.contents);
    _this9 = _super14.call(this, parameters, {
      isRenderable: isRenderable,
      ignoreBorder: true
    });
    _this9.containerClassName = "polylineAnnotation";
    _this9.svgElementName = "svg:polyline";
    return _this9;
  }
...
var PolygonAnnotationElement = /*#__PURE__*/function (_PolylineAnnotationEl) {
  ...
  function PolygonAnnotationElement(parameters) {
    ...
    _this10 = _super15.call(this, parameters);
    _this10.containerClassName = "polygonAnnotation";
    _this10.svgElementName = "svg:polygon";
    return _this10;
  }
...
var InkAnnotationElement = /*#__PURE__*/function (_AnnotationElement11) {
  ...
  function InkAnnotationElement(parameters) {
    ...
    var isRenderable = !!(parameters.data.hasPopup || parameters.data.title || parameters.data.contents);
    _this11 = _super17.call(this, parameters, {
      isRenderable: isRenderable,
      ignoreBorder: true
    });
    _this11.containerClassName = "inkAnnotation";
...
var FileAttachmentAnnotationElement = /*#__PURE__*/function (_AnnotationElement17) {
  ...
  function FileAttachmentAnnotationElement(parameters) {
    ...
    _this12 = _super23.call(this, parameters, {
      isRenderable: true
    });
    var _this12$data$file = _this12.data.file,
        filename = _this12$data$file.filename,
        content = _this12$data$file.content;
    _this12.filename = (0, _display_utils.getFilenameFromUrl)(filename);
    _this12.content = content;
    (_this12$linkService$e = _this12.linkService.eventBus) === null || _this12$linkService$e === void 0 ? void 0 : _this12$linkService$e.dispatch("fileattachmentannotation", {
      source: _assertThisInitialized(_this12),
...
var _network_utils = __w_pdfjs_require__(143);
...
var _content_disposition = __w_pdfjs_require__(144);
...
var _annotation_layer = __w_pdfjs_require__(137);

var _api_compatibility = __w_pdfjs_require__(129);

var _worker_options = __w_pdfjs_require__(132);

var _text_layer = __w_pdfjs_require__(139);

var _svg = __w_pdfjs_require__(140);

var _xfa_layer = __w_pdfjs_require__(141);

var pdfjsVersion = '2.9.273';
var pdfjsBuild = 'e394da586';
{
  var _require = __w_pdfjs_require__(6),
      isNodeJS = _require.isNodeJS;

  if (isNodeJS) {
    var PDFNodeStream = __w_pdfjs_require__(142).PDFNodeStream;

    (0, _api.setPDFNetworkStreamFactory)(function (params) {
      return new PDFNodeStream(params);
    });
  } else {
    var PDFNetworkStream = __w_pdfjs_require__(145).PDFNetworkStream;

    var PDFFetchStream;

    if ((0, _display_utils.isFetchSupported)()) {
      PDFFetchStream = __w_pdfjs_require__(146).PDFFetchStream;
    }
